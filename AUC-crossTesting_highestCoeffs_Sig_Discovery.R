...
S100B_Sig_sm = read.csv("final_coeffs_S100B_7genes.csv")
CD45_Sig_sm = read.csv("final_coeffs_CD45_6genes.csv")
CD68_Sig_sm = read.csv("final_coeffs_CD68_7genes.csv")
pBulk_Sig_sm = read.csv("final_coeffs_pBulk_2genes.csv")
pStroma_Sig_sm = read.csv("final_coeffs_pStroma_7genes.csv")
...
pROC_S100B_S100B <- roc(S100B_S100B_AUC$response,S100B_S100B_AUC$lasso_scores,
                       smoothed = FALSE,
                       # arguments for ci
                       ci=TRUE, ci.alpha=0.95, stratified=FALSE, na.rm = TRUE,
                       # arguments for plot
                       plot=TRUE, auc.polygon=FALSE, max.auc.polygon=FALSE, grid=FALSE,
                       print.auc=TRUE, show.thres=FALSE, direction = '<')
...
CD45_S100B_AUC = as.data.frame(CD45_S100B_AUC)
...
CD68_S100B_AUC = as.data.frame(CD68_S100B_AUC)
...
CD45_sig = read.csv("Diff_signatures_in_CD45_comp.csv")
...
CD68_sig = read.csv("Diff_signatures_in_CD68_comp.csv")
...
S100B_sig = read.csv("Diff_signatures_in_S100B_comp.csv")
...
pBulk_sig = read.csv("Diff_signatures_in_pBulk_comp.csv")
...
pStroma_sig = read.csv("Diff_signatures_in_pStroma_comp.csv")
