...
train_data5 = train_data4[,1:13]
train_data5 <- log2(train_data5)
...
A = ggsurvplot(fit, data = train_data3,
           title = "CD45 compartment w/ CD68 signatures",
...
A$plot <- A$plot+ 
  ggplot2::annotate("text", 
                    ...
                    label = "HR = 1.6 (0.52-5.2) \n p = 0.395", size = 4)
A

# CD45 Compartment with CD68 Signatures
