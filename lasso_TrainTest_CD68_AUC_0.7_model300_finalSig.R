...
aucs = read.csv("aucs_CD68_300.csv")
...
write.csv(goodModelGeneCounts,"goodModelCounts_CD68_from300.csv")
#goodModelGeneCounts = read.csv("goodModelCounts_CD68.csv",row.names = 1)
