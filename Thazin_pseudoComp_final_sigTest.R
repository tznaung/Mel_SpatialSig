...
pseudo_comp <- roc(resps ~ S100B + CD45 + CD68 ,
                   data = sigScores2, direction = '<')

pseudo_comp_2 <- ggroc(pseudo_comp, size = 1.5)
pseudo_comp_2 + theme_classic() + scale_colour_manual(values = c("springgreen3", "gold",  "firebrick3"))
