...
final_coeffs_2 = final_coeffs[-c(1,5,8,9,10,11,12),]
...
#pdf(file = paste("output_split__final.pdf", sep=""))
...
A = ggsurvplot(fit, data = train_data3,
               title = "Pseudo-Bulk w/ S100B signatures",
...
A$plot <- A$plot+ 
  ggplot2::annotate("text", 
                    ...
                    label = "HR = 1.1 (0.48-2.7) \n p = 0.774", size = 4)
A

# PseudoBulk with S100B signatures
