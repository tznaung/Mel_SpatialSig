...
pBulk = read.csv("pBulk_B3.csv", row.names = 2)
pStroma = read.csv("pStroma_B3.csv", row.names = 2)
S100B = read.csv("S100B_B3.csv", row.names = 2)
CD68 = read.csv("CD68_B3.csv", row.names = 2)
CD45 = read.csv("CD45_B3.csv", row.names = 2)
...
print(aucs_all)
write.csv(aucs_all, "aucs_all_B3.csv")
